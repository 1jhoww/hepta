      ...
      <div className={`${styles.container} container`}>
        ...
        <div className={styles.topSection}>
          <div className={styles.brandBlock}>
            {/* Logo fallback */}
            <a href="#home" onClick={(e) => handleScrollTo(e, 'home')} className={styles.logoLink}>
              {!logoError ? (
                <img
                  src="/logohepta.png"
                  alt="HEPTA Studios"
        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.legalLinks}>
            <a href="#privacy" onClick={(e) => e.preventDefault()}>Política de Privacidade</a>
            <a href="#terms" onClick={(e) => e.preventDefault()}>Termos de Serviço</a>
          </div>
        </div>
      </div>
    </footer>
